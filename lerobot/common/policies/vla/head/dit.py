...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        self.z_embedder = LabelEmbedder(
            in_size=token_size, hidden_size=hidden_size, dropout_prob=class_dropout_prob
        )
...
def DiT_S(**kwargs):  # noqa: N802
    return DiT(depth=6, hidden_size=384, num_heads=4, **kwargs)


def DiT_B(**kwargs):  # noqa: N802
    return DiT(depth=12, hidden_size=768, num_heads=12, **kwargs)


def DiT_L(**kwargs):  # noqa: N802
